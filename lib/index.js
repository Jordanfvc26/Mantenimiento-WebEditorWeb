...
wew.newHTML = () => {
    var fields = [];
    fields.push({ field: "", type: "html", label: "<h1><img src='" + wew.menu.querySelector("#wew_newImg").src + "' class='wew_ImgMenu'/> New File</h1>" });
    fields.push({ field: "filename", type: "text", label: "File Name<br/>", htmlParams: "value=\"index.html\" style=\"text-align:center;\" required" });
...
wew.saveHTML = () => {
    document.querySelector("#wew").style.display = "none";
    jsPopupBox.prompt("<h1><img src='" + wew.menu.querySelector("#wew_saveImg").src + "' class='wew_ImgMenu'/> Save File</h1>File Name", wew.curFile, "text-align:center").then((filename) => {
...
wew.openRenameDialog = () => {
    document.querySelector("#wew").style.display = "none";
    jsPopupBox.prompt("<h1><img src='" + wew.menu.querySelector("#wew_newImg").src + "' class='wew_ImgMenu'/> Rename File</h1>File Name", wew.curFile, "text-align:center").then((filename) => {
        document.querySelector("#wew").style.display = "block";
        wew.setCurFile(filename.trim());
        wew.editor.refresh();
        wew.editor.focus();
...
wew.openAboutDialog = () => {
    ...
    message += "<p>Under GNU General Public License.</p>";
    message += "<h2>1.4 - build 2021-05-26</h2>";
    message += "<p>(c) Copyright 2020~2021 <b>Marcos Morise</b>. All rights reserved.</p>";
    message += "<p><b>SoLUC.org</b> - Software Livre Unindo Conhecimentos</p>";
    message += "<p>site: <a href='http://soluc.org' target='blank'>http://soluc.org</a><br/>";
    message += "contact: <a href='mailto:org.soluc@gmail.com' target='blank'/>org.soluc@gmail.com</a></p>";
    message += "<p>Icons by <b>gnome-look.org</b> under GNU General Public License<br/>";
    message += "Code editor API by <b>CodeMirror</b> under MIT License</p>";
    message += "<br/>";
    message += "<b>Donate:</b>";
...
wew.openHelpDialog = () => {
    let message = "";
    message += "<h1><img src='" + wew.menu.querySelector("#wew_helpImg").src + "' class='wew_ImgMenu'/> Help</h1>";
    message += "<h2>Shortcuts</h2>";
    message += "<table cellspacing='10'>";
    message += "<tr><td align='right'><b>Ctrl + Alt + N</b><td align='left'>New file";
    message += "<tr><td align='right'><b>Ctrl + O</b><td align='left'>Open/Upload file to edit";
    message += "<tr><td align='right'><b>Ctrl + S</b><td align='left'>Save/Download current file";
    message += "<tr><td align='right'><td align='left'>";
    message += "<tr><td align='right'><b>F1</b><td align='left'>Open this help";
    message += "<tr><td align='right'><b>F2</b><td align='left'>Rename current file";
    message += "<tr><td align='right'><b>F3</b><td align='left'>Search";
    message += "<tr><td align='right'><b>F9</b><td align='left'>Run current HTML";
    message += "<tr><td align='right'><b>F8</b><td align='left'>Options";
    message += "<tr><td align='right'><b>F10</b><td align='left'>Show / Hide menu";
    message += "<tr><td align='right'><td align='left'>";
    message += "<tr><td align='right'><b>Ctrl + F</b><td align='left'>Find in doc";
    message += "<tr><td align='right'><b>Ctrl + Shift + F</b><td align='left'>Find and Replace in doc";
    message += "<tr><td align='right'><td align='left'>";
    message += "<tr><td align='right'><b>Tab</b><td align='left'> Indent current/selected line(s)";
    message += "<tr><td align='right'><b>Shift + Tab</b><td align='left'> Indent less current/selected line(s)";
    message += "<tr><td align='right'><b>Ctrl + Q</b><td align='left'>Code folds";
    message += "<tr><td align='right'><b>Ctrl + Space</b><td align='left'>Autocomplete";
    message += "<tr><td align='right'><b>Alt + Shift + F</b><td align='left'>Format code";
    message += "<tr><td align='right'><td align='left'>";
    message += "<tr><td align='right'><b>Ctrl + Shift + Up</b><td align='left'>Duplicate current/selected line(s) above";
    message += "<tr><td align='right'><b>Ctrl + Shift + Down</b><td align='left'>Duplicate current/selected line(s) below";
    message += "<tr><td align='right'><b>Alt + Shift + Up</b><td align='left'>Move current/selected line(s) above";
    message += "<tr><td align='right'><b>Alt + Shift + Down</b><td align='left'>Move current/selected line(s) below";
    message += "</table><br/>";
    document.querySelector("#wew").style.display = "none";
    jsPopupBox.alert(message).then(() => {
        document.querySelector("#wew").style.display = "block";
...
wew.openConfigDialog = () => {
    let linesStyle = window.getComputedStyle(document.querySelector("div[class=CodeMirror-gutters]"));
    var fields = [];
    fields.push({ field: "", type: "html", label: "<h1><img src='" + wew.menu.querySelector("#wew_configImg").src + "' class='wew_ImgMenu'/> Config</h1>" });
    fields.push({ field: "theme", type: "select", label: "<br/>Theme<br/>", htmlParams: "id='selectheme'" });
    ...
    fields.push({
        field: "", type: "html", label: `
          <h1 onclick="alert()">Paleta de Colores</h1>
          <span id="color1" style="border: 1px solid red;">‎ ‎ ‎ ‎ ‎ ‎ </span>
          <span id="color2" style="border: 1px solid red;">‎ ‎ ‎ ‎ ‎ ‎ </span>
          <span id="color3" style="border: 1px solid red;">‎ ‎ ‎ ‎ ‎ ‎ </span>
          
        `
    });

    fields.push({ field: "fontSize", type: "number", label: "<br/><br/>Font size<br/>", htmlParams: "value=" + wew.fontSize + " min=1 step=0.5 required style=\"width:30%; text-align:center;\"" });
    ...
    fields.push({ field: "viewBracketsKeys", type: "checkbox", label: "<big>Show <b>quotes</b> and <b>brackets</b> keyboard</big><br/><br/>", htmlParams: wew.viewBracketsKeys ? "checked" : "" });
    fields.push({ field: "autoCloseBrackets", type: "checkbox", label: "<big>Auto close <b>brackets</b></big><br/><br/>", htmlParams: wew.autoCloseBrackets ? "checked" : "" });
    fields.push({ field: "autoCloseTags", type: "checkbox", label: "<big>Auto close <b>tags</b></big>", htmlParams: wew.autoCloseTags ? "checked" : "" });
    ...
    // Buscar el elemento select correspondiente al menú desplegable "theme"
    const selectTheme = document.getElementById("selectheme");

    // Agregar un controlador de eventos onchange al elemento select
    ...
    function handleThemeChange(theme) {
        // Hacer algo con el valor seleccionado, por ejemplo:
        wew.theme = theme;
        wew.editor.setOption("theme", wew.theme);
        let linesStyle = window.getComputedStyle(document.querySelector("div[class=CodeMirror-gutters]"));
        document.getElementById("color1").style.backgroundColor = linesStyle.getPropertyValue("background-color");
        document.getElementById("color2").style.backgroundColor = linesStyle.getPropertyValue("border-right-color");
        document.getElementById("color3").style.backgroundColor = linesStyle.getPropertyValue("color");
        console.log("El tema seleccionado es:", theme);
    }
