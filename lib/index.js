...
wew.openHelpDialog = () => {
    ...
    message += "<h2>Atajos de teclado</h2>";
...
wew.openConfigDialog = () => {
    ...
    fields.push({ field: "theme", type: "select", label: "<br/>Tema<br/>", htmlParams: "id='selectheme'" });
    ...
    fields.push({
        field: "", type: "html", label: `
          <h3 onclick="alert()">Paleta de Colores</h3>
    ...
    fields.push({ field: "fontSize", type: "number", label: "<br/><br/>Tamaño de Fuente<br/>", htmlParams: "value=" + wew.fontSize + " min=1 step=0.5 required style=\"width:30%; text-align:center;\"" });
    ...
    fields.push({ field: "viewBracketsKeys", type: "checkbox", label: "<big>Mostrar el teclado de <b>comillas</b> y <b>corchetes</b><br/></big><br/><br/>", htmlParams: wew.viewBracketsKeys ? "checked" : "" });
    fields.push({ field: "autoCloseBrackets", type: "checkbox", label: "<big>Cerrar automáticamente los <b>corchetes</b></big><br/><br/>", htmlParams: wew.autoCloseBrackets ? "checked" : "" });
    fields.push({ field: "autoCloseTags", type: "checkbox", label: "<big><b>Etiquetas</b> de cierre automático</big>", htmlParams: wew.autoCloseTags ? "checked" : "" });
    ...
    function handleThemeChange(theme) {
        ...
        wew.editor.setOption("theme", color_antes);
