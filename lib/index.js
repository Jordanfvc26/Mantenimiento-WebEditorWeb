...
wew.openConfigDialog = () => {
    ...
    fields.push({field: "theme", type: "select", label: "<br/><br/>Idioma del editor:<br/>"});
    fields.push({field: "theme", type: "option", label: "Inglés"});
    fields.push({field: "theme", type: "option", label: "Español"});
