...
*/
wew.imgHTML = "img/icon-HTML.png";
wew.imgCSS = "img/icon-CSS.png";
wew.imgJS = "img/icon-JS.png";
wew.imgXML = "img/icon-XML.png";
wew.imgJSON = "img/icon-JSON.png";
wew.imgTXT = "img/icon-TXT.png";
...
wew.openRenameDialog = () => {
    document.querySelector("#wew").style.display = "none";
    jsPopupBox.prompt("<h1><img src='" + wew.menu.querySelector("#wew_newImg").src + "' class='wew_ImgMenu'/> Renombrar archivo</h1><img style: margin-right:10px width: 20px; src='img/icon-rename2.png' Nuevo nombre del archivo:", wew.curFile, "text-align:center").then((filename) => {
        document.querySelector("#wew").style.display = "block";
        wew.setCurFile(filename.trim());
        wew.editor.refresh();
        wew.editor.focus();
...
wew.openConfigDialog = () => {
    ...
    fields.push({ field: "theme", type: "select", label: "<br/>Tema del Editor<br/>", htmlParams: "id='selectheme'" });
